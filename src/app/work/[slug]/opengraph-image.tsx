...
export default async function OgImage({ params }: Props) {
  ...
  return new ImageResponse(
    (
      ...
      >
        {/* Frame */}
        <div style={{ position: "absolute", inset: "20px", border: "1px solid rgba(255,255,255,0.08)", display: "flex" }} />
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ color: "rgba(255,255,255,0.25)", fontSize: "11px", letterSpacing: "0.22em" }}>
            FRANCISC.CV
          </span>
          <span style={{ color: "rgba(255,255,255,0.15)", fontSize: "11px", letterSpacing: "0.1em" }}>
            /
          </span>
          <span style={{ color: "rgba(255,255,255,0.25)", fontSize: "11px", letterSpacing: "0.22em" }}>
            WORK
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          ...
          <span style={{ color: "rgba(255,255,255,0.15)", fontSize: "10px", letterSpacing: "0.12em" }}>
            francisc.cv
          </span>
        </div>
      </div>
